...
export function DropIndicator({ edge, gap }: { edge: Edge; gap: string }) {
  ...
  return (
    <div
      ...
      className={`absolute z-10 w-full h-1 bg-blue-700 pointer-events-none before:content-[''] before:w-[--terminal-size] before:h-[--terminal-size] box-border before:absolute before:border-[length:--line-thickness] before:border-solid before:border-blue-700 before:rounded-full ${
