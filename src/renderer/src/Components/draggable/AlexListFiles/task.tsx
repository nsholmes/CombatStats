    ...
    <>
      <div className='relative'>
        <div
          ...
          ref={ref}
          className={`flex text-sm text-black bg-amber-500 flex-row items-center border border-solid rounded p-2 pl-0 hover:bg-slate-100 hover:cursor-grab ${
...
function DragPreview({ task }: { task: TTask }) {
  return (
    <div className='border-solid rounded p-2 text-black bg-white'>
      {task.content}
    </div>
  );
}
