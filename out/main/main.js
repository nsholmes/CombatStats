 ...
 * limitations under the License.
 */
const assert = function(assertion, message2) {
  if (!assertion) {
    throw assertionError(message2);
  }
};
const assertionError = function(message2) {
...
function requireStreams() {
  ...
  var Stream = require$$0$1.Stream, util = require$$2;
...
function requireBase() {
  ...
  hasRequiredBase = 1;
  var Buffer2 = requireSafeBuffer().Buffer, Emitter = require$$1.EventEmitter, util = require$$2, streams2 = requireStreams(), Headers = requireHeaders(), Reader = requireStream_reader();
  ...
  var instance = {
    ...
    _failHandshake: function(error2) {
      ...
      headers2.set("Content-Length", Buffer2.byteLength(error2.message, "utf8"));
      headers2 = ["HTTP/1.1 400 Bad Request", headers2.toString(), error2.message];
      this._write(Buffer2.from(headers2.join("\r\n"), "utf8"));
...
function requireHttp_parser() {
  ...
  var NodeHTTPParser = requireHttpParser().HTTPParser, Buffer2 = requireSafeBuffer().Buffer;
  var TYPES = {
...
function requireFunctor() {
  ...
  Functor.prototype.call = function(error2, message2, callback, context) {
...
function requireCell() {
  ...
  Cell.prototype.incoming = function(error2, message2, callback, context) {
    this._exec("incoming", error2, message2, callback, context);
  };
  Cell.prototype.outgoing = function(error2, message2, callback, context) {
  ...
  Cell.prototype._exec = function(direction, error2, message2, callback, context) {
...
function requireWebsocket_extensions() {
  ...
  var instance = {
    ...
    validFrameRsv: function(frame2) {
      ...
      if (Extensions.MESSAGE_OPCODES.indexOf(frame2.opcode) >= 0) {
...
function requireHybi() {
  ...
  hasRequiredHybi = 1;
  var Buffer2 = requireSafeBuffer().Buffer, crypto = require$$1$1, util = require$$2, Extensions = requireWebsocket_extensions(), Base = requireBase(), Frame = requireFrame(), Message = requireMessage();
  ...
  var instance = {
    ...
    _sendFrame: function(frame2) {
      var length = frame2.length, header = length <= 125 ? 2 : length <= 65535 ? 4 : 10, offset = header + (frame2.masked ? 4 : 0), buffer = Buffer2.allocUnsafe(offset + length), masked = frame2.masked ? this.MASK : 0;
    ...
    _handshakeResponse: function() {
      ...
      return Buffer2.from(headers2.join("\r\n"), "utf8");
    },
...
function requireProxy() {
  ...
  hasRequiredProxy = 1;
  var Buffer2 = requireSafeBuffer().Buffer, Stream = require$$0$1.Stream, url = require$$2$1, util = require$$2, Base = requireBase(), Headers = requireHeaders(), HttpParser = requireHttp_parser();
  var PORTS = { "ws:": 80, "wss:": 443 };
  var Proxy2 = function(client2, origin, options) {
  ...
  var instance = {
    ...
    start: function() {
      ...
      this.emit("data", Buffer2.from(headers2.join("\r\n"), "utf8"));
      return true;
    },
    pause: function() {
      this._paused = true;
...
function requireClient$1() {
  ...
  var Buffer2 = requireSafeBuffer().Buffer, crypto = require$$1$1, url = require$$2$1, util = require$$2, HttpParser = requireHttp_parser(), Base = requireBase(), Hybi = requireHybi(), Proxy2 = requireProxy();
...
function requireDraft75() {
  ...
  var Buffer2 = requireSafeBuffer().Buffer, Base = requireBase(), util = require$$2;
  ...
  var instance = {
    ...
    frame: function(buffer) {
      ...
      var length = Buffer2.byteLength(buffer), frame2 = Buffer2.allocUnsafe(length + 2);
      frame2[0] = 0;
...
function requireDraft76() {
  ...
  var Buffer2 = requireSafeBuffer().Buffer, Base = requireBase(), Draft75 = requireDraft75(), crypto = require$$1$1, util = require$$2;
...
function requireServer() {
  ...
  hasRequiredServer = 1;
  var util = require$$2, HttpParser = requireHttp_parser(), Base = requireBase(), Draft75 = requireDraft75(), Draft76 = requireDraft76(), Hybi = requireHybi();
  ...
  Server.http = function(request, options) {
    ...
    var headers2 = request.headers, version2 = headers2["sec-websocket-version"], key2 = headers2["sec-websocket-key"], key1 = headers2["sec-websocket-key1"], key22 = headers2["sec-websocket-key2"], url = this.determineUrl(request);
    if (version2 || key2)
...
function requireDriver() {
  ...
  hasRequiredDriver = 1;
  var Base = requireBase(), Client = requireClient$1(), Server = requireServer();
  var Driver = {
...
function requireApi() {
  ...
  hasRequiredApi = 1;
  var Stream = require$$0$1.Stream, util = require$$2, driver2 = requireDriver(), EventTarget = requireEvent_target(), Event = requireEvent();
  var API = function(options) {
    options = options || {};
    driver2.validateOptions(options, ["headers", "extensions", "maxLength", "ping", "proxy", "tls", "ca"]);
    this.readable = this.writable = true;
    var headers2 = options.headers;
    if (headers2) {
      for (var name2 in headers2) this._driver.setHeader(name2, headers2[name2]);
    }
  ...
  var instance = {
    ...
    _emitError: function(message2) {
      ...
      var event2 = new Event("error", { message: message2 });
...
function requireClient() {
  ...
  hasRequiredClient = 1;
  var util = require$$2, net = require$$1$2, tls = require$$2$2, url = require$$2$1, driver2 = requireDriver(), API = requireApi();
  requireEvent();
  var DEFAULT_PORTS = { "http:": 80, "https:": 443, "ws:": 80, "wss:": 443 }, SECURE_PROTOCOLS = ["https:", "wss:"];
  var Client = function(_url, protocols, options) {
    options = options || {};
    this.url = _url;
    this._driver = driver2.client(this.url, { maxLength: options.maxLength, protocols });
  ...
  Client.prototype._configureProxy = function(proxy2, originTLS) {
    ...
    if (proxy2.headers) {
      for (name2 in proxy2.headers) this._proxy.setHeader(name2, proxy2.headers[name2]);
    }
...
function requireEventsource() {
  ...
  var Stream = require$$0$1.Stream, util = require$$2, driver2 = requireDriver(), Headers = requireHeaders(), API = requireApi(), EventTarget = requireEvent_target(), Event = requireEvent();
  var EventSource = function(request, response, options) {
    ...
    var scheme = driver2.isSecureRequest(request) ? "https:" : "http:";
...
function requireWebsocket() {
  ...
  var util = require$$2, driver2 = requireDriver(), API = requireApi();
  var WebSocket2 = function(request, socket, body, protocols, options) {
    options = options || {};
    this._stream = socket;
    this._driver = driver2.http(request, { maxLength: options.maxLength, protocols });
    var self2 = this;
    if (!this._stream || !this._stream.writable) return;
  ...
  WebSocket2.isWebSocket = function(request) {
    return driver2.isWebSocket(request);
  };
  WebSocket2.validateOptions = function(options, validKeys) {
    driver2.validateOptions(options, validKeys);
  };
  WebSocket2.WebSocket = WebSocket2;
  WebSocket2.Client = requireClient();
  WebSocket2.EventSource = requireEventsource();
...
function sparseSnapshotTreeForEachTree(sparseSnapshotTree, prefixPath, func) {
  if (sparseSnapshotTree.value !== null) {
    ...
    sparseSnapshotTreeForEachChild(sparseSnapshotTree, (key, tree) => {
      const path2 = new Path(prefixPath.toString() + "/" + key);
...
function compoundWriteAddWrite(compoundWrite, path2, node) {
  if (pathIsEmpty(path2)) {
...
function compoundWriteAddWrites(compoundWrite, path2, updates) {
  ...
  each(updates, (childKey, node) => {
    newWrite = compoundWriteAddWrite(newWrite, pathChild(path2, childKey), node);
  });
  return newWrite;
}
...
const resolveDeferredValueTree = function(path2, node, syncTree, serverValues) {
  return resolveDeferredValue(node, new DeferredValueProvider(syncTree, path2), serverValues);
};
...
function treeSubTree(tree, pathObj) {
  ...
  let child2 = tree, next = pathGetFront(path2);
  while (next !== null) {
  ...
  if (data && typeof data === "object") {
    ...
    each(data, (key, value) => {
      if (key === ".value") {
        ...
        hasActualChild = true;
        if (!isValidKey(key)) {
          throw new Error(errorPrefix2 + " contains an invalid key (" + key + ") " + validationPathToErrorString(path2) + `.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);
        }
      }
      validationPathPush(path2, key);
...
function repoOnDataUpdate(repo, pathString, data, isMerge, tag) {
  ...
  if (tag) {
    if (isMerge) {
      ...
      events = syncTreeApplyTaggedQueryMerge(repo.serverSyncTree_, path2, taggedChildren, tag);
    } else {
      const taggedSnap = nodeFromJSON(data);
      events = syncTreeApplyTaggedQueryOverwrite(repo.serverSyncTree_, path2, taggedSnap, tag);
    }
  } else if (isMerge) {
    const changedChildren = map(data, (raw) => nodeFromJSON(raw));
    events = syncTreeApplyServerMerge(repo.serverSyncTree_, path2, changedChildren);
  } else {
    const snap = nodeFromJSON(data);
    events = syncTreeApplyServerOverwrite(repo.serverSyncTree_, path2, snap);
  }
...
function repoUpdateInfo(repo, pathString, value) {
  ...
  const events = syncTreeApplyServerOverwrite(repo.infoSyncTree_, path2, newNode);
  eventQueueRaiseEventsForChangedPath(repo.eventQueue_, path2, events);
}
...
function repoSetWithPriority(repo, path2, newVal, newPriority, onComplete) {
  ...
  const events = syncTreeApplyUserOverwrite(repo.serverSyncTree_, path2, newNode, writeId, true);
...
function repoRunOnDisconnectEvents(repo) {
  ...
  sparseSnapshotTreeForEachTree(repo.onDisconnect_, newEmptyPath(), (path2, node) => {
    const resolved = resolveDeferredValueTree(path2, node, repo.serverSyncTree_, serverValues);
    sparseSnapshotTreeRemember(resolvedOnDisconnectTree, path2, resolved);
  });
  let events = [];
  sparseSnapshotTreeForEachTree(resolvedOnDisconnectTree, newEmptyPath(), (path2, snap) => {
    events = events.concat(syncTreeApplyServerOverwrite(repo.serverSyncTree_, path2, snap));
    const affectedPath = repoAbortTransactions(repo, path2);
    repoRerunTransactions(repo, affectedPath);
  });
...
class IKFService {
  ...
  initializeFirebase() {
    try {
      ...
      console.error("Failed to initialize Firebase:", error2);
    }
  }
  ensureDirectories() {
    const dirs = [
  ...
  async fetchEventsFromFSI() {
    ...
    try {
      ...
      console.error("Error fetching events from FSI:", error2);
      throw new Error(`Failed to fetch events: ${error2.message}`);
    }
    ...
    const events = data.sporting_events.filter((sEvent) => sEvent.promoter?.id && sEvent.id).map((sEvent) => ({
  ...
  // ===== PARTICIPANT METHODS =====
  async fetchEventParticipants(eventUID, eventID) {
    ...
    const data = await response.json();
    const FSIParticipants = data.seps || [];
    const participants = FSIParticipants.map(
      (participant) => ({
        ...
        phoneNumber: participant.person.contactinfo_list.phones[0]?.phone_number || "",
        bracketCount: 0,
        checkedIn: false
      })
    );
  ...
  readParticipantsFromFile(eventUID, eventID) {
    const fileName = `${eventUID.replace(/\|/g, "")}.${eventID}`;
    const filePath = path.join(this.dataPath, "eventParticipants", fileName);
    if (!fs.existsSync(filePath)) {
      return [];
  ...
  async fetchAllParticipants(onProgress) {
    ...
    for (let i = 0; i < events.length; i++) {
      ...
      if (onProgress) {
        onProgress(i + 1, events.length, event2.eventName);
      }
      try {
        await this.fetchEventParticipants(event2.eventUid, event2.id);
        successCount++;
        await new Promise((resolve) => setTimeout(resolve, 500));
      } catch (error2) {
        console.error(`Error fetching participants for event ${event2.id}:`, error2);
        errorCount++;
      }
    }
  ...
  async fetchEventBrackets(eventUID, eventID) {
    ...
    const data = await response.json();
    const brackets = data.brackets.map((bracket) => ({
      ...
      fighterIds: bracket.seps.map((sep) => sep.competitor.id),
      fighterGym: bracket.seps.map((sep) => ({
  ...
  readBracketsFromFile(eventUID, eventID) {
    const fileName = `${eventUID.replace(/\|/g, "")}.${eventID}`;
    const filePath = path.join(this.dataPath, "eventBrackets", fileName);
    if (!fs.existsSync(filePath)) {
      return [];
  ...
  // ===== ENRICHMENT METHODS =====
  async enrichParticipantsWithProfileId(eventId, forceUpdate, onProgress) {
    const participantsDir = path.join(this.dataPath, "eventParticipants");
    const cacheFilePath = path.join(this.dataPath, ".profileIdCache.json");
    const profileIdCache = /* @__PURE__ */ new Map();
    if (!forceUpdate && fs.existsSync(cacheFilePath)) {
      const cacheData2 = JSON.parse(fs.readFileSync(cacheFilePath, "utf8"));
      Object.entries(cacheData2).forEach(([email, profileId]) => {
    ...
    for (const file of participantFiles) {
      ...
      for (let i = 0; i < participants.length; i++) {
        ...
        try {
          ...
          console.error(`Error enriching participant ${participant.email}:`, error2);
          failedCount++;
        }
      }
      if (updated) {
  ...
  async searchProfileByEmail(email) {
    ...
    try {
      ...
      console.error(`Error searching for ${email}:`, error2);
      return null;
    }
  }
  // ===== STATUS METHODS =====
  getParticipantStatus() {
    ...
    const eventsWithoutParticipants = [];
    events.forEach((event2) => {
      const fileName = `${event2.eventUid.replace(/\|/g, "")}.${event2.id}`;
      const filePath = path.join(participantsDir, fileName);
      if (fs.existsSync(filePath)) {
        eventsWithParticipants.push(`${event2.eventName} (${event2.id})`);
      } else {
        eventsWithoutParticipants.push(`${event2.eventName} (${event2.id})`);
      }
    });
  ...
  async validateToken() {
    try {
      ...
      return { valid: false, message: `Error validating token: ${error2}` };
    }
  }
  // ===== FIREBASE SYNC METHODS =====
  async syncEventsToFirebase(onProgress) {
    if (!this.fbDatabase) {
    ...
    for (let i = 0; i < events.length; i++) {
      ...
      try {
        await set(ref(this.fbDatabase, `ikf/events/${event2.id}`), event2);
        successCount++;
      } catch (error2) {
        console.error(`Failed to sync event ${event2.id}:`, error2);
        errorCount++;
      }
    }
    return { success: successCount, errors: errorCount };
  }
  async syncParticipantsToFirebase(eventUID, eventID) {
    if (!this.fbDatabase) {
      throw new Error("Firebase not initialized");
    }
  ...
  async syncBracketsToFirebase(eventUID, eventID) {
    if (!this.fbDatabase) {
      throw new Error("Firebase not initialized");
    }
    ...
    for (const bracket of brackets) {
      try {
        ...
        console.error(`Failed to sync bracket ${bracket.id}:`, error2);
        errorCount++;
      }
    }
    return { success: successCount, errors: errorCount };
...
ipcMain.on("read-event-participants", (event2, eventUID, eventId) => {
  ...
  try {
    ...
    event2.sender.send("read-event-participants-success", fileContent);
...
ipcMain.on("read-event-brackets", (event2, eventUID, eventId) => {
  console.log(
  ...
  try {
    ...
    event2.sender.send("read-event-brackets-success", fileContent);
    console.log("Main: Received read-event-brackets-success event.");
  } catch {
    dialog.showErrorBox("File Not Found", "File Not Found");
  }
});
ipcMain.on("refresh-event-participants", (event2, eventUID, eventId) => {
  console.log("Event UID:", eventUID);
  console.log("Event ID:", eventId);
  console.log("event: ", event2.type);
  ...
  try {
    ...
    console.error("Error spawning nhe-cli command:", error2);
...
ipcMain.handle("ikf:fetch-participants", async (_, eventUID, eventID) => {
  try {
...
ipcMain.handle("ikf:read-participants", async (_, eventUID, eventID) => {
  try {
...
ipcMain.handle("ikf:fetch-all-participants", async (event2) => {
  try {
    const result = await ikfService.fetchAllParticipants(
      (current, total, eventName) => {
        event2.sender.send("ikf:fetch-all-participants-progress", {
          current,
          total,
          eventName
        });
...
ipcMain.handle("ikf:fetch-brackets", async (_, eventUID, eventID) => {
  try {
...
ipcMain.handle("ikf:read-brackets", async (_, eventUID, eventID) => {
  try {
...
ipcMain.handle("ikf:enrich-participants", async (event2, eventId, forceUpdate) => {
  try {
    const result = await ikfService.enrichParticipantsWithProfileId(
      eventId,
      forceUpdate,
      (current, total, participantName) => {
        event2.sender.send("ikf:enrich-participants-progress", {
          current,
          total,
          participantName
        });
...
ipcMain.handle("ikf:update-token", async (_, token) => {
  try {
...
ipcMain.handle("ikf:sync-events-to-firebase", async (event2) => {
  try {
    const result = await ikfService.syncEventsToFirebase(
      (current, total, eventName) => {
        event2.sender.send("ikf:sync-events-progress", {
          current,
          total,
          eventName
        });
...
ipcMain.handle("ikf:sync-participants-to-firebase", async (_, eventUID, eventID) => {
  try {
...
ipcMain.handle("ikf:sync-brackets-to-firebase", async (_, eventUID, eventID) => {
  try {
